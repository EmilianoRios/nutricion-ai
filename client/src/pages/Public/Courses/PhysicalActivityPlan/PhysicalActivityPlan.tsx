...
const PhysicalActivityPlan : React.FC<PhysicalActivityPlanInterface> = () => {
	...
	<Heading fontSize={40} p={4}>Plan de Actividad Física</Heading>
	<Divider
    ...
    px={12}
    py={4}>
		<Text px='5' fontSize={23} textAlign='justify'>
            ...
            >
              ...
              >
                ...
                >
				  ...
				  <Text bg={GlobalColorSettings.BGPRICESCOURSES} borderRadius={50} px={6} py={2} fontSize='18' as='b'>$230</Text>
                </Flex>
              </Box>
            </Flex>
          </SwiperSlide>
            ...
            >
              ...
              >
                ...
                >
				  ...
				  <Text bg={GlobalColorSettings.BGPRICESCOURSES} borderRadius={50} px={6} py={2} fontSize='18' as='b'>$280</Text>
                </Flex>
              </Box>
            </Flex>
          </SwiperSlide>
